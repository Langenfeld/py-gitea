...
class ApiObjectsPopulationTest(TestCase, FieldCheckingTestCase):
    ...
    def test_org_field_population(self):
        ...
        self._check_fields(Organization, org)

    def test_branch_field_population(self):
        if not self.g.get_version().startswith(CURRENT_VERSION):
            return
        branches = self.repo.get_branches()
        self._check_fields(Branch, branches[0])
    ...
    def test_labels_field_population(self):
        ...
        assert labels
        self._check_fields(Label, labels[0])
    ...
    def test_milestone_field_population(self):
        ...
        assert mss
        ms = mss[0]
        self._check_fields(Milestone, ms)
    ...
    def test_content_field_population(self):
        ...
        self._check_fields(Content, readmes[0])
