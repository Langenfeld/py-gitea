...
class DiffType1(Enum):
    diff = 'diff'
    patch = 'patch'


class DiffType2(Enum):
    diff = 'diff'
    patch = 'patch'
...
class ReposOwnerRepoLanguagesGetResponse(BaseModel):
    __root__: Optional[Dict[str, int]] = None


class ReposOwnerRepoLanguagesGetResponse1(BaseModel):
    __root__: Optional[Dict[str, int]] = None


class SubjectTypeEnum1(Enum):
    issue = 'issue'
    pull = 'pull'
    commit = 'commit'
    repository = 'repository'
...
class DiffType3(Enum):
    diff = 'diff'
    patch = 'patch'


class DiffType4(Enum):
    diff = 'diff'
    patch = 'patch'


class DiffType5(Enum):
    diff = 'diff'
    patch = 'patch'
